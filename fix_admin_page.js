...
import DashboardClient from './DashboardClient'; // We will create this for client interactions if needed
  ...
  return (
    <>
      <header className="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-4">
        ...
        <img className="w-full h-full object-cover rounded-full" src="https://lh3.googleusercontent.com/aida-public/AB6AXuC2_gL929Y-4pF03IW9z-RI4u1oLCWCxd4o1u_H72CAE5BNlZhGFJMyqSD5YF0SYJ-vEKnpJXUZPbXV_aN0vczoc1VyB7v__uG8YxxB943x89ib1msbR0ob--TNNWy6OV5LOrlySBpBnrsb25BiesHk5lKSeJDYgK7B1mZj4Nxw08BrdJmwbajQZQsch3rrxF__aSZs0c_AS0cAlQOpygoJUlO0USAGKeS2w1NYJV3rbAYitByYkpGfBF5mebboJMY5e6UNoDfIw0c"/>
        </button>
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-gutter mb-section-gap">
        ...
        <div className="sparkline flex items-end gap-[2px] h-8 w-20">
        <div className="spark-bar h-[40%] w-1 bg-primary rounded-full"></div>
        <div className="spark-bar h-[60%] w-1 bg-primary rounded-full"></div>
        <div className="spark-bar h-[50%] w-1 bg-primary rounded-full"></div>
        <div className="spark-bar h-[80%] w-1 bg-primary rounded-full"></div>
        <div className="spark-bar h-[90%] w-1 bg-primary rounded-full"></div>
        </div>
        </div>
        ...
        <div className="sparkline flex items-end gap-[2px] h-8 w-20">
        <div className="spark-bar h-[30%] w-1 bg-primary rounded-full"></div>
        <div className="spark-bar h-[40%] w-1 bg-primary rounded-full"></div>
        <div className="spark-bar h-[70%] w-1 bg-primary rounded-full"></div>
        <div className="spark-bar h-[60%] w-1 bg-primary rounded-full"></div>
        <div className="spark-bar h-[85%] w-1 bg-primary rounded-full"></div>
        </div>
        </div>
        ...
        <div className="spark-bar h-[50%] w-1 bg-primary rounded-full"></div>
        <div className="spark-bar h-[30%] w-1 bg-primary rounded-full"></div>
        <div className="spark-bar h-[20%] w-1 bg-primary rounded-full"></div>
        </div>
        </div>
        ...
        <div className="spark-bar h-[30%] w-1 bg-primary rounded-full"></div>
        <div className="spark-bar h-[70%] w-1 bg-primary rounded-full"></div>
        <div className="spark-bar h-[95%] w-1 bg-primary rounded-full"></div>
        </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-gutter">
        ...
        {latestLeads.length === 0 && (
            <tr><td colSpan={5} className="py-4 text-center text-on-surface-variant">No hay leads recientes</td></tr>
        )}
        </tbody>
        </table>
        </div>
        ...
        {upcomingVisits.length === 0 && (
            <p className="text-sm text-center text-on-surface-variant py-4">No hay visitas programadas</p>
        )}
