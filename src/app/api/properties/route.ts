    ...
    try {
        ...
        const property = await prisma.property.create({
            data: {
                ...
                videos: data.videos ? String(data.videos) : null,
                documents: data.documents ? String(data.documents) : null,
                shortDesc: data.shortDesc ? String(data.shortDesc) : null,
                ...
                currency: data.currency ? String(data.currency) : "COP",
                parking: data.parking ? parseInt(data.parking) : null,
                stratum: data.stratum ? parseInt(data.stratum) : null,
                antiquity: data.antiquity ? parseInt(data.antiquity) : null,
                adminFee: data.adminFee ? parseFloat(data.adminFee) : null,
                lotArea: data.lotArea ? parseFloat(data.lotArea) : null,
