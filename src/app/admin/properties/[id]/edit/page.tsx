                        ...
                        <div className="bg-surface p-6 rounded-2xl border border-outline-variant/40 shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                <div className="space-y-1 relative group">
                                    ...
                                    <input name="price" type="number" required defaultValue={property.price} className="w-full border-b-2 border-outline-variant bg-transparent p-0 focus:border-primary focus:ring-0 text-on-surface font-body-lg placeholder-on-surface-variant/50 pb-1" placeholder="Ej: 450000000" />
                                </div>
                                <div className="space-y-1 relative group">
                                    <label className="font-label-md text-label-md text-on-surface-variant flex items-center gap-1">Administración</label>
                                    <input name="adminFee" type="number" defaultValue={property.adminFee || ''} className="w-full border-b-2 border-outline-variant bg-transparent p-0 focus:border-primary focus:ring-0 text-on-surface font-body-lg placeholder-on-surface-variant/50 pb-1" placeholder="Ej: 350000" />
                                </div>
                                <div className="space-y-1 relative group">
                                    <label className="font-label-md text-label-md text-on-surface-variant flex items-center gap-1">Moneda</label>
                                    <select name="currency" defaultValue={property.currency || 'COP'} className="w-full border-b-2 border-outline-variant bg-transparent p-0 focus:border-primary focus:ring-0 text-on-surface font-body-lg pb-1">
